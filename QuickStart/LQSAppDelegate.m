 ...
 */
static NSString *const LQSLayerAppIDString = @"8dae80f2-ceaf-11e4-b923-e1fb000000f4";

#if TARGET_IPHONE_SIMULATOR
    // If on simulator set the user ID to Simulator and participant to Device
    NSString *const LQSCurrentUserID = @"Simulator test";
    NSString *const LQSParticipantUserID = @"Device test";
    ...
    NSString *const LQSCurrentUserID = @"Device test";
    NSString *const LQSParticipantUserID = @"Simulator test";
